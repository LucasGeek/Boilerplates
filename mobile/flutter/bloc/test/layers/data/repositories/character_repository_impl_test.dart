...
void main() {
  setUp(() {
    ...
    characterRepository = CharacterRepositoryImpl(
      networkInfo: networkInfoMock ?? NetworkInfoMock(),
      localDatasource: localDatasource ?? CharacterLocalDatasourceMock(),
      networkDatasource: networkDatasource ?? CharacterNetworkDatasourceMock(),
      inMemoryCache: inMemoryCache ?? InMemoryCacheMock(),
    );
  });
